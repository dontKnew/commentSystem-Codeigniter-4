...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mt-2"> Comment System</h1>
            ...
            <!-- <div class="comment-body form-control my-1">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <small>- commented at 20/21/2022 </small> <br>
                        <span> I Love your work bro</span>
                    </div>
                </div>
                <strong style="margin-left:65px"> Like  Reply</strong> 
                <div class="d-flex my-1" style="margin-left:65px" class="replyComments">
                    <img  src="https://th.bing.com/th/id/OIP.1gKc5uC3sZvJC_98dfC9ogHaHa?pid=ImgDet&rs=1" class="rounded-circle mx-2" width="50px"  height="50px" alt="profile">
                    <div>
                        <strong>Sajid Ali </strong> 
                        <small>- commented at 20/21/2022 </small> <br>
                ...
                <strong style="margin-left:130px" class='cursor-pointer'> Like  Reply</strong> 
              </div> -->
        </section>
    </div>
